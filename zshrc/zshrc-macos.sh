...
#############################################################################
# awsp, claudeb — defined in zshrc/modules/awsp.sh (shared with Linux)

#############################################################################
#                              pi coding agent (Bedrock)
#############################################################################

# pi: macOS only (binary not available on Linux).
# awsp is defined in the shared awsp.sh module loaded before this file.
function pi() {
  case "${1:-}" in
