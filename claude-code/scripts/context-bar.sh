#!/bin/bash
# ~/code/personal/my-shell-my-rules/claude-code/scripts/context-bar.sh
# Two-line Claude Code status bar with Eldritch colorscheme
# Based on: github.com/ykdojo/claude-code-tips/blob/main/scripts/context-bar.sh

# Eldritch color theme: cyan, green, purple, orange, magenta, red, yellow, lime
COLOR="purple"

# Eldritch palette — true color (24-bit) for exact hex match
C_RESET='\033[0m'
C_GRAY='\033[38;2;165;175;194m'       # #a5afc2 (Eldritch grey)
C_BAR_EMPTY='\033[38;2;33;35;55m'     # #212337 (Eldritch bg/black)
case "$COLOR" in
    cyan)     C_ACCENT='\033[38;2;4;209;249m' ;;    # #04d1f9
    green)    C_ACCENT='\033[38;2;55;244;153m' ;;    # #37f499
    purple)   C_ACCENT='\033[38;2;152;122;251m' ;;   # #987afb
    orange)   C_ACCENT='\033[38;2;247;198;127m' ;;   # #f7c67f
    magenta)  C_ACCENT='\033[38;2;164;140;242m' ;;   # #a48cf2
    red)      C_ACCENT='\033[38;2;241;108;117m' ;;   # #f16c75
    yellow)   C_ACCENT='\033[38;2;241;252;121m' ;;   # #f1fc79
    lime)     C_ACCENT='\033[38;2;154;217;0m' ;;     # #9ad900
    *)        C_ACCENT="$C_GRAY" ;;
esac
...
# Build output line 1: Model | Dir | Branch (status) | Context
